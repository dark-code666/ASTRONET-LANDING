  ...
  return (
    <section className="bg-white py-4 overflow-hidden ">
      <div className="mx-auto max-w-7xl px-6 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        <div className="relative flex justify-center gap-3 h-[600px]"> 
          ...
          {[0, 1, 2].map((index) => (
            ...
            <div key={index} className="flex flex-col">
              ...
              <div className="relative mx-auto border-zinc-150 bg-zinc-950 border-[7px] rounded-[2.5rem] h-[500px] w-[220px] shadow-2xl">
                ...
                {/* PANTALLA CON SCROLL */}
                <div className="rounded-[2.1rem] overflow-hidden w-full h-full bg-white relative z-10">
                  <motion.div
        ...
        <div className="space-y-10">
          <h2 className="text-5xl font-bold tracking-tight text-zinc-950 leading-[1.1]">
