    ...
    <section  className="bg-white py-40 px-6 md:px-12 lg:px-24 flex flex-col items-center justify-center border-b border-zinc-100">
      ...
      <form className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="flex flex-col gap-2">
          ...
          <input type="text" className="w-full border border-zinc-200 p-4 rounded-md focus:outline-none focus:border-zinc-900 transition-colors dark:bg-white/5 dark:border-white/10 dark:text-white" />
        </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <input type="email" className="w-full border border-zinc-200 p-4 rounded-md focus:outline-none focus:border-zinc-900 transition-colors dark:bg-white/5 dark:border-white/10 dark:text-white" />
        </div>
