...
export default function StartProyectOne() {
  return (
    <section className="bg-zinc-50 dark:bg-[#050505] py-30 px-6 md:px-12 lg:px-24 flex flex-col items-center justify-center border-b border-zinc-100 dark:border-white/5">
      ...
      <form className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="flex flex-col gap-2">
          ...
          <input type="text" className="  w-full bg-white dark:bg-white/5 border border-zinc-200 dark:border-white/10 p-4 rounded-md focus:outline-none focus:border-zinc-900 dark:focus:border-white transition-colors dark:text-white" />
        </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <input type="email" className="w-full bg-white dark:bg-white/5 border border-zinc-200 dark:border-white/10 p-4 rounded-md focus:outline-none focus:border-zinc-900 dark:focus:border-white transition-colors dark:text-white" />
        </div>
        ...
        <div className="flex flex-col gap-2 md:col-span-2">
          ...
          <textarea rows={5} className="w-full bg-white dark:bg-white/5 border border-zinc-200 dark:border-white/10 p-4 rounded-md focus:outline-none focus:border-zinc-900 dark:focus:border-white transition-colors resize-none dark:text-white" />
        </div>
        ...
        <p className="md:col-span-2 text-center text-zinc-400 dark:text-zinc-500 text-[10px] mt-4">
