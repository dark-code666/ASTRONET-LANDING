...
const AboutHero = () => (
  <section className="px-6 py-20 bg-white dark:bg-[#050505] mt-10">
    <div className="max-w-7xl mx-auto bg-[#0a1212] rounded-[40px] overflow-hidden flex flex-col md:flex-row items-center border border-zinc-800/50">
      <div className="w-full md:w-1/2 h-[500px]">
        <img 
          ...
          alt="Astronet Offshore execution partner"
        />
      </div>
      <div className="w-full md:w-1/2 p-12 md:p-20 text-white">
        ...
        <h1 className="font-serif text-4xl md:text-5xl leading-tight mb-8">
          We help companies build and scale <br />
          <span className="italic font-normal text-zinc-400">digital products.</span>
        </h1>
        <p className="text-zinc-400 text-base leading-relaxed font-light mb-4">
          At Astronet, we combine software engineering, AI-powered systems, and dedicated product teams to help businesses launch faster, expand engineering capacity, and streamline operations.
        </p>
        <p className="text-zinc-400 text-base leading-relaxed font-light">
          From SaaS platforms and ecommerce ecosystems to internal business tools and operational workflows, we build scalable systems designed for long-term growth — not just short-term delivery.
        </p>
      </div>
    </div>
  </section>
    ...
    <section className="py-14 bg-[#f8f9fa] dark:bg-zinc-900/20 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
          <div>
            <h2 className="text-3xl font-bold mb-2 dark:text-white text-zinc-950">Overall Rating</h2>
            <div className="flex items-center gap-4">
              <span className="text-5xl font-black dark:text-white text-zinc-950">5.0</span>
          ...
          {reviews.map((rev, i) => (
            <div key={i} className="bg-white dark:bg-zinc-800/50 p-6 rounded-2xl shadow-sm border border-zinc-100 dark:border-zinc-700/50">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <div className="text-sm font-bold flex items-center gap-1 dark:text-white text-zinc-950">
...
const ClientsSection = () => {
  ...
  return (
    <section className="py-24 bg-white dark:bg-[#050505] px-6">
      <div className="max-w-5xl mx-auto text-center">
        <h2 className="font-serif text-4xl md:text-5xl mb-16 italic dark:text-zinc-200 text-zinc-950">
          Some of Our Clients.
        </h2>
...
export default function AboutUs() {
  return (
    <main className="bg-white dark:bg-[#050505] transition-colors overflow-hidden">
      <AboutHero />
      <ReviewsSection />
      <ClientsSection />
    </main>
